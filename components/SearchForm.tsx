...
export const formSchema = z.object({
  ...
  adults: z
    ...
    .max(12, { message: 'Maximum of 12 adults' }),
...
function SearchForm() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const url = new URL('https://www.booking.com/searchresults.html?ss=')
  ...
  return (
    <Form {...form}>
      <form
        ...
        className="flex flex-col lg:flex-row lg:max-w-6wl lg:mx-auto items-center justify-center space-x-0 lg:space-x-2 space-y-4 lg:space-y-0 rounded-lg"
      >
        ...
        <div className="flex w-full items-center space-x-2">
          ...
          <div className="mt-auto">
            <Button
              type="submit"
              className="bg-blue-500 text-base flex text-white"
            >
              Search
            </Button>
          </div>
